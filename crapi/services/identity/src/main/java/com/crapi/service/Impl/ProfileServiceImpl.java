...
public class ProfileServiceImpl implements ProfileService {
  ...
  @Value("${app.enable_legacy_video_processing}")
  private boolean enable_legacy_video_processing;
    ...
    try {
      if (xForwardedHost == null) {
        if (videoId != null && videoId > 0) {
          ...
          if (optionalProfileVideo.isPresent() && !enable_legacy_video_processing) {
            profileVideo = optionalProfileVideo.get();
            ...
            return new CRAPIResponse(UserMessage.CONVERT_VIDEO_INTERNAL_ERROR, 500);
              ...
              && enable_legacy_video_processing
