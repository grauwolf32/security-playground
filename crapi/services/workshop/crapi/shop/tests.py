...
class ProductTestCase(TestCase):
    ...
    def test_apply_coupon_with_quoted_code(self):
        """
        applies a coupon whose code embeds a stray quote and an extra
        clause, then asserts the API responds with the expected message.
        :return: None
        """
        coupon_details = {
    ...
    def test_get_order_without_auth_header(self):
        """
